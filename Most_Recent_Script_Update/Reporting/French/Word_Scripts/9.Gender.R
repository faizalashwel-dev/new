png("Word_Outputs/9.Genre/1.Contole_par_Genre.png", height = 600, width = 900)
par(mar=c(5,3,3,2),mfrow=c(2,2), cex=0.9)
boxplot(dat$Gender_MaleControl~dat$TVA_quartiles, col="lightgray", outline=F, main="Contrôle Homme Adulte",xlab='',names=qnames, las=2)
boxplot(dat$Gender_FemaleControl~dat$TVA_quartiles, col="lightgray", outline=F, main="Contrôle Femme Adulte",xlab='', names=qnames, las=2)
boxplot(dat$Gender_MaleYouthControl~dat$TVA_quartiles, col="lightgray", outline=F, main="Contrôle Jeune Homme",xlab='', names=qnames, las=2)
boxplot(dat$Gender_FemaleYouthControl~dat$TVA_quartiles, col="lightgray", outline=F, main="Contrôle Jeune Femme",xlab='', names=qnames, las=2)
dev.off()


rowSums(data.frame(dat$Gender_FemaleControl, dat$Gender_FemaleYouthControl, dat$Gender_MaleControl, dat$Gender_MaleYouthControl))
