...
# 
# png("Word_Outputs/8.Household_Heads/1.HH_Heads_Marital.png")
...
# plot
# ggsave("Word_Outputs/8.Household_Heads/2.Marital_Status_By_Quartile.png")
...
colours<- c('darkred', 'orange', 'darkgreen', 'darkblue')
 ...
 png("Word_Outputs/8.Household_Heads/1.Household_details.png", height = 800, width = 900)
...
png("Word_Outputs/8.Household_Heads/2.Head_Education.png")
...
write.csv(round(rbind(t(table(dat$Head_EducationLevel, dat$TVA_quartiles))/prop_rat*100, colSums(t(table(dat$Head_EducationLevel, dat$TVA_quartiles))/prop_rat*100)),2), "Word_Outputs/8.Household_Heads/2.Education_table.csv")
