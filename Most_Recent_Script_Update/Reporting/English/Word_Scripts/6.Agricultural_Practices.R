...
# plot
# ggsave("Word_Outputs/6.Agricultural_Practices/1.Crops_use.png")
###------------------------------
...
write.csv(crops_most_important, "Word_Outputs/6.Agricultural_Practices/1.Crops_Summary.csv", row.names = F)


png("Word_Outputs/6.Agricultural_Practices/1.Crop_Summary.png", height = 1000, width = 1200)
...
# plot
# ggsave("Word_Outputs/6.Agricultural_Practices/3.Crops_Residue_Uses.png")
...
{
png("Word_Outputs/6.Agricultural_Practices/2.Average_crop_yields.png", height = 700, width = 700); par(mar=c(9,4,4,2), cex=1.6)
boxplot(data.frame(imp_crop_yields), las=2, col="lightgray", ylab="Yields (tons/ha)",  main="Crop Yields\n(per hectare)", outline=F)
dev.off()
}


 png("Word_Outputs/6.Agricultural_Practices/4.Average_crop_harvest.png", height = 700, width = 700); par(mar=c(9,4,4,2), cex=1.6)
 boxplot(data.frame(imp_crop_harvests), las=2, col="lightgray", ylab="Harvest (tons)",  main="Crop Yields", outline=F)
 dev.off()
...
write.csv(crop_yield_df, "Word_Outputs/6.Agricultural_Practices/2.crop_yields_harvest_table.csv", row.names = F)
...
write.csv(Livestock_most_important, "Word_Outputs/6.Agricultural_Practices/3.Livestock_summary_table.csv", row.names = F)


png("Word_Outputs/6.Agricultural_Practices/3.Livestock_summary.png", height = 1000, width = 1200)
par(cex=1, mar=c(10,5,5,5))
...
png("Word_Outputs/6.Agricultural_Practices/4.Livestock_Heads.png", height = 1000, width = 1200)
...
write.csv(livestock_heads_summary, "Word_Outputs/6.Agricultural_Practices/4.livestock_heads_table.csv", row.names = F)
