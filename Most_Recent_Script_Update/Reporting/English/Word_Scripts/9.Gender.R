...
boxplot(dat$Gender_MaleControl~dat$TVA_quartiles, col="lightgray", outline=F, main="Male Adult Control",xlab = '', names=qnames, las=2)
boxplot(dat$Gender_FemaleControl~dat$TVA_quartiles, col="lightgray", outline=F, main="Female Adult Control",xlab = '', names=qnames, las=2)
boxplot(dat$Gender_MaleYouthControl~dat$TVA_quartiles, col="lightgray", outline=F, main="Male Youth Control", xlab = '',names=qnames, las=2)
boxplot(dat$Gender_FemaleYouthControl~dat$TVA_quartiles, col="lightgray", outline=F, main="Female Youth Control", xlab = '',names=qnames, las=2)
dev.off()
