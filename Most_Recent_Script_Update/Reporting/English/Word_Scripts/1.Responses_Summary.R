...
colnames(Responses_per_Village)<- c("Village", "Number of Responses")
write.csv(Responses_per_Village,"Word_Outputs/1.Responses_Summary/Responses_per_village.csv",  row.names = F)

png("Word_Outputs/1.Responses_Summary/1.Responses_per_Village.png")
par(mar=c(10,4,4,1), mfrow=c(1,1),mgp=c(3,2,0), cex=(0.8))
barplot(Responses_per_Village$`Number of Responses`, las=2, ylab="Number of HHs", main = "Number of HHs per Village", names.arg = Responses_per_Village$Village)
dev.off()
Responses_per_Village<-data.frame(Responses_per_Village)
colnames(Responses_per_Village)<- c("Village", "Number of HHs")
write.csv(Responses_per_Village,"Word_Outputs/1.Responses_Summary/1.Responses_per_Village_table.csv",row.names = F)
...
# #png("Word_Outputs/1.Responses_Summary/4.male_female_respondents.png")
...
# male_female_plot
# ggsave("Word_Outputs/1.Responses_Summary/3.male_female_respondents.png")
# 
# write.csv(plot_male_female_change, "Word_Outputs/1.Responses_Summary/3.male_female_respondents_table.csv")
# 
