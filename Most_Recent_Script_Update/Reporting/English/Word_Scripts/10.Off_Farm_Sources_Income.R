...
png("Word_Outputs/10.Off_Farm_Sources_Income/1.Off_Farm_Incomes.png", height = 1000, width = 1200)
barplot(temp$Freq*100, main = "Any Off-Farm Incomes", names.arg = temp$Var1, ylab = "Percentage of HHs")
dev.off()

png("Word_Outputs/10.Off_Farm_Sources_Income/2.Off_farm_hist.png",height = 600, width = 1200)
...
write.table(off_farm_income_table, file = "Word_Outputs/10.Off_Farm_Sources_Income/2.Off_Farm_Incomes_table.csv",sep=",", col.names = F)
...
write.csv(off_farm_summary, "Word_Outputs/10.Off_Farm_Sources_Income/4.Off_Farm_Incomes_sources.csv", row.names = F)


png("Word_Outputs/10.Off_Farm_Sources_Income/4.Off_Farm_Income_Sources.png", height = 1000, width = 1200)
